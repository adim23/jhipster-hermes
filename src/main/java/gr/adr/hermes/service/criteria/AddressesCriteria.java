...
/**
 * Criteria class for the {@link gr.adr.hermes.domain.Addresses} entity. This class is used
 * in {@link gr.adr.hermes.web.rest.AddressesResource} to receive all the possible filtering options from
