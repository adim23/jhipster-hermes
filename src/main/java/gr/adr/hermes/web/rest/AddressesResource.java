...
import gr.adr.hermes.service.AddressesQueryService;
import gr.adr.hermes.service.AddressesService;
import gr.adr.hermes.service.criteria.AddressesCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.Addresses}.
 */
@RestController
@RequestMapping("/api")
public class AddressesResource {
    ...
    public ResponseEntity<List<Addresses>> getAllAddresses(AddressesCriteria criteria, Pageable pageable) {
