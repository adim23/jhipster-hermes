...
import gr.adr.hermes.service.CodesQueryService;
import gr.adr.hermes.service.CodesService;
import gr.adr.hermes.service.criteria.CodesCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.Codes}.
 */
@RestController
@RequestMapping("/api")
public class CodesResource {
     ...
     */
    @GetMapping("/codes")
    public ResponseEntity<List<Codes>> getAllCodes(CodesCriteria criteria, Pageable pageable) {
