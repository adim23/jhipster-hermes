...
import gr.adr.hermes.service.CitiesQueryService;
import gr.adr.hermes.service.CitiesService;
import gr.adr.hermes.service.criteria.CitiesCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.Cities}.
 */
@RestController
@RequestMapping("/api")
public class CitiesResource {
     ...
     */
    @GetMapping("/cities")
    public ResponseEntity<List<Cities>> getAllCities(CitiesCriteria criteria, Pageable pageable) {
