...
import gr.adr.hermes.service.CitizensRelationsQueryService;
import gr.adr.hermes.service.CitizensRelationsService;
import gr.adr.hermes.service.criteria.CitizensRelationsCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.CitizensRelations}.
 */
@RestController
@RequestMapping("/api")
public class CitizensRelationsResource {
    ...
    public ResponseEntity<List<CitizensRelations>> getAllCitizensRelations(CitizensRelationsCriteria criteria, Pageable pageable) {
