...
import gr.adr.hermes.service.MaritalStatusQueryService;
import gr.adr.hermes.service.MaritalStatusService;
import gr.adr.hermes.service.criteria.MaritalStatusCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.MaritalStatus}.
 */
@RestController
@RequestMapping("/api")
public class MaritalStatusResource {
    ...
    public ResponseEntity<List<MaritalStatus>> getAllMaritalStatuses(MaritalStatusCriteria criteria, Pageable pageable) {
