...
import gr.adr.hermes.service.CitizenFoldersQueryService;
import gr.adr.hermes.service.CitizenFoldersService;
import gr.adr.hermes.service.criteria.CitizenFoldersCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.CitizenFolders}.
 */
@RestController
@RequestMapping("/api")
public class CitizenFoldersResource {
    ...
    public ResponseEntity<List<CitizenFolders>> getAllCitizenFolders(CitizenFoldersCriteria criteria, Pageable pageable) {
