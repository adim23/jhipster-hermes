...
import gr.adr.hermes.service.CitizensMeetingsQueryService;
import gr.adr.hermes.service.CitizensMeetingsService;
import gr.adr.hermes.service.criteria.CitizensMeetingsCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.CitizensMeetings}.
 */
@RestController
@RequestMapping("/api")
public class CitizensMeetingsResource {
    ...
    public ResponseEntity<List<CitizensMeetings>> getAllCitizensMeetings(CitizensMeetingsCriteria criteria, Pageable pageable) {
