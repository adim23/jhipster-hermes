...
import gr.adr.hermes.service.ContactTypesQueryService;
import gr.adr.hermes.service.ContactTypesService;
import gr.adr.hermes.service.criteria.ContactTypesCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.ContactTypes}.
 */
@RestController
@RequestMapping("/api")
public class ContactTypesResource {
    ...
    public ResponseEntity<List<ContactTypes>> getAllContactTypes(ContactTypesCriteria criteria, Pageable pageable) {
