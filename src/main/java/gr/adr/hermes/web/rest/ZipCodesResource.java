...
import gr.adr.hermes.service.ZipCodesQueryService;
import gr.adr.hermes.service.ZipCodesService;
import gr.adr.hermes.service.criteria.ZipCodesCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.ZipCodes}.
 */
@RestController
@RequestMapping("/api")
public class ZipCodesResource {
    ...
    public ResponseEntity<List<ZipCodes>> getAllZipCodes(ZipCodesCriteria criteria, Pageable pageable) {
