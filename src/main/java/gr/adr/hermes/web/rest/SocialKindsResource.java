...
import gr.adr.hermes.service.SocialKindsQueryService;
import gr.adr.hermes.service.SocialKindsService;
import gr.adr.hermes.service.criteria.SocialKindsCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.SocialKinds}.
 */
@RestController
@RequestMapping("/api")
public class SocialKindsResource {
    ...
    public ResponseEntity<List<SocialKinds>> getAllSocialKinds(SocialKindsCriteria criteria, Pageable pageable) {
