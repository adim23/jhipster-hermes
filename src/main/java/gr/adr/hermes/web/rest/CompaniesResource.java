...
import gr.adr.hermes.service.CompaniesQueryService;
import gr.adr.hermes.service.CompaniesService;
import gr.adr.hermes.service.criteria.CompaniesCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.Companies}.
 */
@RestController
@RequestMapping("/api")
public class CompaniesResource {
    ...
    public ResponseEntity<List<Companies>> getAllCompanies(CompaniesCriteria criteria, Pageable pageable) {
