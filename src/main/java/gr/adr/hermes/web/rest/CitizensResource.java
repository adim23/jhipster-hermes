...
import gr.adr.hermes.service.CitizensQueryService;
import gr.adr.hermes.service.CitizensService;
import gr.adr.hermes.service.criteria.CitizensCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.Citizens}.
 */
@RestController
@RequestMapping("/api")
public class CitizensResource {
     ...
     */
    @GetMapping("/citizens")
    public ResponseEntity<List<Citizens>> getAllCitizens(CitizensCriteria criteria, Pageable pageable) {
