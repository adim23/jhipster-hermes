...
import gr.adr.hermes.service.SocialContactsQueryService;
import gr.adr.hermes.service.SocialContactsService;
import gr.adr.hermes.service.criteria.SocialContactsCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.SocialContacts}.
 */
@RestController
@RequestMapping("/api")
public class SocialContactsResource {
    ...
    public ResponseEntity<List<SocialContacts>> getAllSocialContacts(SocialContactsCriteria criteria, Pageable pageable) {
