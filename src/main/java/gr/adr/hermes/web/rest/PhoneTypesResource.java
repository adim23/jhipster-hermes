...
import gr.adr.hermes.service.PhoneTypesQueryService;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.PhoneTypes}.
 */
@RestController
@RequestMapping("/api")
public class PhoneTypesResource {
    ...
    public ResponseEntity<List<PhoneTypes>> getAllPhoneTypes(PhoneTypesCriteria criteria, Pageable pageable) {
