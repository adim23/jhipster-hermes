...
import gr.adr.hermes.service.EmailsQueryService;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.Emails}.
 */
@RestController
@RequestMapping("/api")
public class EmailsResource {
     ...
     */
    @GetMapping("/emails")
    public ResponseEntity<List<Emails>> getAllEmails(EmailsCriteria criteria, Pageable pageable) {
