...
import gr.adr.hermes.service.CompanyKindsQueryService;
import gr.adr.hermes.service.CompanyKindsService;
import gr.adr.hermes.service.criteria.CompanyKindsCriteria;
...
/**
 * REST controller for managing {@link gr.adr.hermes.domain.CompanyKinds}.
 */
@RestController
@RequestMapping("/api")
public class CompanyKindsResource {
    ...
    public ResponseEntity<List<CompanyKinds>> getAllCompanyKinds(CompanyKindsCriteria criteria, Pageable pageable) {
