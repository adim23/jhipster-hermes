...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './origins.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORIGINS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORIGINS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORIGINS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORIGINS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORIGINS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORIGINS actions', async () => {
      const expectedActions = [
        {
