...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALCONTACTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIALCONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIALCONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIALCONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALCONTACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIALCONTACTS actions', async () => {
      const expectedActions = [
        {
