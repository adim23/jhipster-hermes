...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTTYPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTACTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTACTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTACTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTACTTYPES actions', async () => {
      const expectedActions = [
        {
