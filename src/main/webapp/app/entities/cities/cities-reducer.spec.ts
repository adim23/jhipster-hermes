...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cities.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITIES actions', async () => {
      const expectedActions = [
        {
