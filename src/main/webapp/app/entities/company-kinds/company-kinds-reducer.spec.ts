...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYKINDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANYKINDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANYKINDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANYKINDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYKINDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANYKINDS actions', async () => {
      const expectedActions = [
        {
