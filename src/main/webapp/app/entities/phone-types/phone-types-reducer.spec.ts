...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHONETYPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHONETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHONETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHONETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHONETYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHONETYPES actions', async () => {
      const expectedActions = [
        {
