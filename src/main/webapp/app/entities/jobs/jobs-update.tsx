  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesApp.jobs.home.createOrEditLabel" data-cy="JobsCreateUpdateHeading">
            <Translate contentKey="hermesApp.jobs.home.createOrEditLabel">Create or edit a Jobs</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesApp.jobs.name')}
                id="jobs-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('hermesApp.jobs.description')}
                id="jobs-description"
                name="description"
                data-cy="description"
                type="text"
