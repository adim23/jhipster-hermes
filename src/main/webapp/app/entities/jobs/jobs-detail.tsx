    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobsDetailsHeading">
          <Translate contentKey="hermesApp.jobs.detail.title">Jobs</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="hermesApp.jobs.name">Name</Translate>
            </span>
          </dt>
          <dd>{jobsEntity.name}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="hermesApp.jobs.description">Description</Translate>
            </span>
          </dt>
          <dd>{jobsEntity.description}</dd>
        </dl>
