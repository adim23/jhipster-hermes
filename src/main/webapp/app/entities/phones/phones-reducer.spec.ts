...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './phones.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHONES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHONES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHONES actions', async () => {
      const expectedActions = [
        {
