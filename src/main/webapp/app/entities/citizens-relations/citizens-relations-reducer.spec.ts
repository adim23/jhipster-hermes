...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './citizens-relations.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITIZENSRELATIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CITIZENSRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITIZENSRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITIZENSRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITIZENSRELATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITIZENSRELATIONS actions', async () => {
      const expectedActions = [
        {
