...
export const CitizensRelationsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesApp.citizensRelations.delete.question">
        <Translate contentKey="hermesApp.citizensRelations.delete.question" interpolate={{ id: citizensRelationsEntity.id }}>
