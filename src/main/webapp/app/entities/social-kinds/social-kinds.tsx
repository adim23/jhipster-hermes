  ...
  return (
    <div>
      <h2 id="social-kinds-heading" data-cy="SocialKindsHeading">
        <Translate contentKey="hermesApp.socialKinds.home.title">Social Kinds</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hermesApp.socialKinds.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hermesApp.socialKinds.home.createLabel">Create new Social Kinds</Translate>
          </Link>
        </div>
      </h2>
        ...
        {socialKindsList && socialKindsList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="hermesApp.socialKinds.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="hermesApp.socialKinds.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="hermesApp.socialKinds.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('call')}>
                  <Translate contentKey="hermesApp.socialKinds.call">Call</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hermesApp.socialKinds.home.notFound">No Social Kinds found</Translate>
            </div>
          )
        )}
      </div>
