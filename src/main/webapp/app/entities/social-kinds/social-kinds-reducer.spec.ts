...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALKINDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIALKINDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIALKINDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIALKINDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALKINDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIALKINDS actions', async () => {
      const expectedActions = [
        {
