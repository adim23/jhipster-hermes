...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './citizens-meetings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITIZENSMEETINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CITIZENSMEETINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITIZENSMEETINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITIZENSMEETINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITIZENSMEETINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITIZENSMEETINGS actions', async () => {
      const expectedActions = [
        {
