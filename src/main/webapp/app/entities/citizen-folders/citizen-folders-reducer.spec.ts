...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITIZENFOLDERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CITIZENFOLDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITIZENFOLDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITIZENFOLDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITIZENFOLDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITIZENFOLDERS actions', async () => {
      const expectedActions = [
        {
