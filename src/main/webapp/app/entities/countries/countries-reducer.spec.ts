...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './countries.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COUNTRIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COUNTRIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COUNTRIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COUNTRIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COUNTRIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COUNTRIES actions', async () => {
      const expectedActions = [
        {
