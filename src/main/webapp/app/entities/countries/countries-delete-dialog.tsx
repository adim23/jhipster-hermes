...
export const CountriesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesApp.countries.delete.question">
        <Translate contentKey="hermesApp.countries.delete.question" interpolate={{ id: countriesEntity.id }}>
