  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesApp.codes.home.createOrEditLabel" data-cy="CodesCreateUpdateHeading">
            <Translate contentKey="hermesApp.codes.home.createOrEditLabel">Create or edit a Codes</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesApp.codes.name')}
                id="codes-name"
                name="name"
                data-cy="name"
                type="text"
