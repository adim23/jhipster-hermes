...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARITALSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MARITALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MARITALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MARITALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MARITALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MARITALSTATUS actions', async () => {
      const expectedActions = [
        {
