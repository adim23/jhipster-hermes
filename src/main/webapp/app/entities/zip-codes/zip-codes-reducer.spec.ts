...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './zip-codes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZIPCODES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ZIPCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ZIPCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ZIPCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ZIPCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ZIPCODES actions', async () => {
      const expectedActions = [
        {
