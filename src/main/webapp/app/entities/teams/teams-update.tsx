  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesApp.teams.home.createOrEditLabel" data-cy="TeamsCreateUpdateHeading">
            <Translate contentKey="hermesApp.teams.home.createOrEditLabel">Create or edit a Teams</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesApp.teams.name')}
                id="teams-name"
                name="name"
                data-cy="name"
                type="text"
