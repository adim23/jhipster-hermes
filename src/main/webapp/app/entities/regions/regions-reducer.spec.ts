...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './regions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REGIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REGIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REGIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REGIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REGIONS actions', async () => {
      const expectedActions = [
        {
