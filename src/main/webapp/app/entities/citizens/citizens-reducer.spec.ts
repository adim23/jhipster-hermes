...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './citizens.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITIZENS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CITIZENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITIZENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITIZENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITIZENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITIZENS actions', async () => {
      const expectedActions = [
        {
