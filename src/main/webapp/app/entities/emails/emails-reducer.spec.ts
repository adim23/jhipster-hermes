...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './emails.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMAILS actions', async () => {
      const expectedActions = [
        {
